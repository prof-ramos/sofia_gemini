  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 md:p-8 text-center bg-gradient-to-b from-white to-neutral/50 relative overflow-hidden overflow-y-auto scrollbar-thin">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-5xl w-full my-auto py-6 md:py-10">
        ...
        <h2 className="font-serif text-3xl md:text-5xl font-bold text-primary mb-3 md:mb-4 tracking-tight">
          Sofia
        </h2>
        ...
        <div className="w-full max-w-4xl mb-12">
          <div className="flex items-center justify-center gap-3 mb-6 opacity-80">
            ...
            <div className="flex items-center gap-2">
               ...
               <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em]">Como posso ajudar?</p>
            </div>
            <div className="h-px w-8 bg-slate-300"></div>
          </div>
        ...
        <button 
          onClick={onStart}
          className="group flex items-center gap-3 bg-primary active:bg-primary-light md:hover:bg-primary-light text-white px-10 py-4 rounded-xl font-bold uppercase tracking-widest shadow-xl shadow-primary/20 transition-all transform md:hover:-translate-y-0.5 active:translate-y-0 active:scale-95 border border-white/10"
        >
